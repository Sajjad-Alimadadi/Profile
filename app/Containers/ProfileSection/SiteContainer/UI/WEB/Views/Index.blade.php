                        ...
                        <div class="row">
                            <div class="col-12 col-md-10 mx-auto">
                                <div class="text-center">
                                    ...
                                    <p class="max-width-450">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                                </div>
                                <div class="row contact-info mt-5">
                                    <div class="col-md-4">
                                        <div class="text-center">
                                            <div>
                                                <h6>ساخته شده توسط :</h6>
                                                <p class="mb-0">مریم رستگار</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="text-md-start mt-5">
                                    <p class="my-3">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد </p>
                                    <p class="mt-3 mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="blog-single modal fade" id="blog-single" tabindex="-1" role="dialog" aria-labelledby="blogModalScrollable" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="blogModalScrollable">بلاگ</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body">
                                    ...
                                    <div class="text-md-start">
                                        ...
                                        <div class="entry-meta mb-4">
                                            <ul class="list-inline">
                                                <li class="list-inline-item">
                                                    <a class="base-color" href="blog-rtl.html"><i class="fa fa-calendar"></i>21 مهر 1401</a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a class="base-color" href="blog-rtl.html" title="Posts by admin" rel="author"><i class="fa fa-user"></i>مدیر</a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a class="base-color" href="blog-rtl.html" rel="category tag"><i class="fa fa-folder-open"></i>طراحی لوگو</a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a class="base-color" href="blog-rtl.html"><i class="fa fa-comments"></i>بدون نظر.</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="entry-content box-border p-3">
                                            ...
                                            <div class="px-md-5 px-3 py-4 quotation">
                                                ...
                                                <h6 class="base-color font-italic mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</h6>
                                            </div>
                                            <p class="my-3">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد.</p>
                                        ...
                                        <!-- Comments -->
                                        <h2 class="text-start my-4">نظرات</h2>
                                            ...
                                            <ul class="comment even thread-even depth-1 list-unstyled comments-list m-0" id="comment-1">
                                                <li id="div-comment-1" class="p-3">
                                                    <div class="comment-wrap">
                                                        <div class="comment-image float-start">
                                                        ...
                                                        <div class="comment-content">
                                                            <div class="comment-author">
                                                                <span>مریم رستگار</span>
                                                                <p class="text-muted comment-date">21 مهر 1401 در 09:13 قبل از ظهر</p>
                                                                <a href="#" class="comment-reply-link"><i class="fa fa-reply fa-flip-horizontal"></i> پاسخ</a>
                                                            </div>
                                                            <div class="comment-text">
                                                                <span>سلام، این یک دیدگاه است. برای شروع کار با مدیریت، ویرایش و حذف نظرات، لطفاً از صفحه نظرات در داشبورد ببینید. آواتارهای نظردهنده از Gravatar می آیند.</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="contact mt-4">
                                            <div class="contact-form">
                                                <h2 class="text-start mb-4">ارسال پاسخ</h2>
                                                <form>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 form-item">
                                                            <div class="input-group mb-3">
                                                                <textarea name="comments" id="blog-comments" rows="4" class="form-control" placeholder="متن پیام..."></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12 mt-4 text-start">
                                                            <div class="button-border">
                                                                <button type="submit" class="pill-button" id="blog-submit-btn">ثبت نظر</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
...
<header>
    <div class="header-navbar h-100">
        <a class="navbar-brand" href="#"><b>ا</b><span>ارشیا</span></a>
        <ul class="list-group menu text-center" id="menu">
            ...
            <li class="list-group-item"><a href="#resume"><i class="fa fa-address-book"></i><span>رزومه من</span></a></li>
            <li class="list-group-item"><a href="#portfolio"><i class="fa fa-briefcase"></i><span>نمونه کارها</span></a></li>
            <li class="list-group-item"><a href="#blog"><i class="fa fa-file-text"></i><span>بلاگ</span></a></li>
            <li class="list-group-item"><a href="#contact"><i class="fa fa-envelope-open"></i><span>تماس با من</span></a></li>
        </ul>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 order-2 order-lg-1">
                            <div class="hero-content">
                                <h1 class="mb-3">من مینا تارخ هستم</h1>
                                <h4 class="text-capitalize mb-0"><span class="base-color">یک  </span> <span class="element" data-elements="طراح.,طراح سایت.,توسعه دهنده وب."></span></h4>
                                <p class="max-width-450 mx-0 my-4">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
            ...
            <div class="display-content">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center title">
                                <h2 class="text-dark"><span class="base-color">درباره</span> من</h2>
                                <p class="text-muted max-width-450 mb-5">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6 mt-4 mt-lg-0">
                            <div class="personal-item ">
                                <h3 class="text-dark mt-4 mt-lg-0"><span class="base-color">UI/UX</span> طراحی و توسعه وب</h3>
                                <div class="row">
                                    <div class="col-6 personal-info">
                                        <ul class="list-unstyled pt-4">
                                            <li>
                                                <p>تاریخ تولد : <span> خرداد 1373</span></p>
                                            </li>
                                            <li>
                                                <p>وب سایت : <span> www.sample.com</span></p>
                                            </li>
                                            <li>
                                                <p>تلفن : <span> 09171234567</span></p>
                                            </li>
                                            <li>
                                                <p>شهر : <span> شیراز</span></p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-6 personal-info">
                                        <ul class="list-unstyled pt-4">
                                            ...
                                            <li>
                                                <p>مدرک : <span> کارشناسی</span></p>
                                            </li>
                                            <li>
                                                <p>ایمیل : <span> info@example.com</span></p>
                                            </li>
                                            <li>
                                                <p>فریلنس : <span> امکان پذیر</span></p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="button-border mt-3 mb-lg-0 me-4">
                                <a href="javascript:void(0);" class="pill-button">دانلود رزومه</a>
                            </div>
                    ...
                    <div id="count-up" class="count-up text-center box-border">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-3 my-3 count-item ">
                                ...
                                <p class="mb-0">فایل های دانلود شده</p>
                            </div>
                            <!-- Item-02 -->
                            <div class="col-6 col-lg-3 my-3 count-item ">
                                <div class="count-icon">
                            ...
                            <div class="col-6 col-lg-3 my-3 count-item ">
                                ...
                                <p class="mb-0">جایزه های دریافت شده</p>
                            </div>
                            <!-- Item-04 -->
                            <div class="col-6 col-lg-3 my-3 count-item ">
                                <div class="count-icon">
                    ...
                    <div class="services">
                        <div class="row mt-5 ">
                            <div class="col-12">
                                <h3 class="mb-0 text-dark"><span class="base-color">خدمات</span> من</h3>
                            </div>
                        </div>
                        <div class="row">
                            <!-- Item 01 -->
                            <div class="col-lg-4 text-start">
                                <div class="services-item box-hover-border">
                                    ...
                                    <div class="services-content">
                                        ...
                                        <p class="text-muted mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Item 02 -->
                            ...
                            <div class="col-lg-4 text-start">
                                <div class="services-item box-hover-border">
                                    ...
                                    <div class="services-content">
                                        <h5 class="mb-3">طراحی ریسپانسیو</h5>
                                        <p class="text-muted mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 text-start">
                                <div class="services-item box-hover-border">
                                    ...
                                    <div class="services-content">
                                        <h5 class="mb-3">هرآنچه انتظار دارید</h5>
                                        <p class="text-muted mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 text-start">
                                <div class="services-item box-hover-border">
                                    ...
                                    <div class="services-content">
                                        <h5 class="mb-3">پشتیبانی حرفه ای</h5>
                                        <p class="text-muted mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="testimonial mt-5">
                        <div class="col-12">
                            <h3 class="mb-0 text-dark"><span class="base-color">نظر</span> مشتریان</h3>
                        </div>
                        <div class="owl-carousel">
                            ...
                            <div class="testimonial-item box-border">
                                ...
                                <p class="mb-0 mt-2 text-muted">" لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است "</p>
                                <span class="d-block mt-3 fw-bold me-2">محمد پناهی،<small class="text-muted"> مدیر سایت</small></span>
                            </div>
                            <!-- Testimonial Item-02 -->
                            <div class="testimonial-item box-border">
                                <div class="testimonial-image">
                                ...
                                <p class="mb-0 mt-2 text-muted">" لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است "</p>
                                <span class="d-block mt-3 fw-bold me-2">مریم رستگار،<small class="text-muted"> مدیر بازاریابی</small></span>
                            </div>
                            <!-- Testimonial Item-03 -->
                            <div class="testimonial-item box-border">
                                <div class="testimonial-image">
                                ...
                                <p class="mb-0 mt-2 text-muted">" لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است "</p>
                                <span class="d-block mt-3 fw-bold me-2">ماندانا راد،<small class="text-muted"> طراح وب</small></span>
                            </div>
                            <!-- Testimonial Item-04 -->
                            <div class="testimonial-item box-border">
                                <div class="testimonial-image">
                                ...
                                <p class="mb-0 mt-2 text-muted">" لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است "</p>
                                <span class="d-block mt-3 fw-bold me-2">آرش صابری،<small class="text-muted"> مدیریت سئو</small></span>
                            </div>
                        </div>
                    </div>
                    <!--    Client End   -->
            ...
            <div class="display-content">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center title">
                                <h2 class="text-dark"><span class="base-color">رزومه</span> من</h2>
                                <p class="text-muted max-width-450 mb-5">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="timeline-items box-border">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-contents">
                                        <div class="time-line-header">
                                            <h6 class="timeline-title">کارشناسی ارشد علوم کامپیوتر</h6>
                                            <p class="timeline-year">1391 - 1394</p>
                                        </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-contents">
                                        <div class="time-line-header">
                                            <h6 class="timeline-title">تحصیل در دانشگاه مهندسی شیراز</h6>
                                            <p class="timeline-year">1394 - 1398</p>
                                        </div>
                                        <div class="timeline-content">
                                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است.</p>
                                        </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-contents">
                                        <div class="time-line-header">
                                            <h6 class="timeline-title">توسعه دهنده UI/UX</h6>
                                            <p class="timeline-year">1398 - 1401</p>
                                        </div>
                                        <div class="timeline-content">
                                            <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است.</p>
                                        </div>
                        ...
                        <div class="col-lg-6 mt-5 mt-lg-0">
                            <h3 class="text-dark">
                                <i class="lni-pencil base-color"></i>تجربیات
                            </h3>
                            <div class="timeline-items box-border">
                                <!--    Item 01   -->
                                <div class="timeline-item">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <h3 class="mb-0"><span class="base-color">مهارت</span> کار</h3>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div>
                                <h3 class="mb-0 mt-5 mt-lg-0"><span class="base-color">مهارت</span> زبان</h3>
                            </div>
                            <div class="language-bar box-border">
                                <div class="language-skill row">
                                    <h4 class="col-6 text-start mb-0">انگلیسی <span> تسلط کامل</span></h4>
                                ...
                                <div class="language-skill row">
                                    <h4 class="col-6 text-start mb-0">عربی <span> تسلط کامل</span></h4>
                                    <ul class="col-6 list-inline text-end mb-0">
                                        <li class="list-inline-item">
                                            <i class="fa fa-star"></i>
                                        </li>
                                ...
                                <div class="language-skill row">
                                    <h4 class="col-6 text-start mb-0">هندی <span> متوسط</span></h4>
                                    <ul class="col-6 list-inline text-end mb-0">
                                        <li class="list-inline-item">
                                            <i class="fa fa-star"></i>
                                        </li>
                                ...
                                <div class="language-skill row">
                                    <h4 class="col-6 text-start mb-0">ترکی <span> متوسط</span></h4>
                                    <ul class="col-6 list-inline text-end mb-0">
                                        <li class="list-inline-item">
                                            <i class="fa fa-star"></i>
                                        </li>
            ...
            <div class="display-content">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center title">
                                <h2 class="text-dark"><span class="base-color">کارهای</span> من</h2>
                                <p class="text-muted mb-5 max-width-450">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <ul id="portfolio-filter" class="list-unstyled list-inline mb-0 col-lg-12 text-center portfolio-filter">
                            ...
                            <li class="button-border list-inline-item">
                                <a href="#" data-filter=".webdesign" class="pill-button">طراحی سایت</a>
                            </li>
                            <li class="button-border list-inline-item">
                                <a href="#" data-filter=".mobiledesign" class="pill-button">طراحی لوگو</a>
                            </li>
                            <li class="button-border list-inline-item">
                                <a href="#" data-filter=".seo" class="pill-button">سئو</a>
                            </li>
                            <li class="button-border list-inline-item">
                                    ...
                                    <div class="img-overlay text-center">
                                        <div class="img-overlay-content">
                                            <div class="portfolio-icon">
                                                <a href="JavaScript:Void();" type="button" data-bs-toggle="modal" data-bs-target="#portfolio-single"><i class="lni-link"></i></a>
                                                <a href="assets/img/portfolio-10.jpg" class="js-zoom-gallery">
                                                    <i class="lni-search"></i>
                                                </a>
                                            </div>
                                            <h5 class="mt-3 mb-0">کار من</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center pt-2">
                            <div class="button-border d-inline-block ms-2 ms-sm-4">
                                <button class="pill-button showMore" id="showMore">مشاهده بیشتر</button>
                            ...
                            <div class="button-border d-inline-block">
                                <a href="portfolio-rtl.html" class="pill-button">صفحه نمونه کارها</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="display-content">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center title">
                                <h2 class="text-dark"><span class="base-color">نوشته های</span> اخیر</h2>
                                <p class="text-muted mb-5 max-width-450">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="blog-content">
                                    <ul class="list-inline mt-4">
                                        <li class="list-inline-item">
                                            ...
                                            <span class="text-muted">21 مهر 1401 </span>
                                        </li>
                                        <li class="list-inline-item">
                                    ...
                                    <h5 class="mb-3"><a class="text-dark" href="javascript:void(0)" target="_blank" data-bs-toggle="modal" data-bs-target="#blog-single">بهترین خودت باش</a></h5>
                            ...
                            <div class="blog-item box-border">
                                ...
                                <div class="blog-content">
                                    <ul class="list-inline mt-4">
                                        <li class="list-inline-item">
                                            <i class="lni-calendar base-color"></i>
                                            <span class="text-muted">13 آذر 1401 </span>
                                        </li>
                                        <li class="list-inline-item">
                                            <i class="lni-comment base-color"></i>
                            ...
                            <div class="blog-item box-border">
                                ...
                                <div class="blog-content">
                                    <ul class="list-inline mt-4">
                                        <li class="list-inline-item">
                                            <i class="lni-calendar base-color"></i>
                                            <span class="text-muted">23 خرداد 1401 </span>
                                        </li>
                                        <li class="list-inline-item">
                                            <i class="lni-comment base-color"></i>
                                    ...
                                    <h5 class="mb-3"><a class="text-dark" href="javascript:void(0)" target="_blank" data-bs-toggle="modal" data-bs-target="#blog-single">رویاهای خود را بنویس</a></h5>
                                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                                    <div class="blog-link">
                                        <a class="base-color" href="javascript:void(0)" target="_blank" data-bs-toggle="modal" data-bs-target="#blog-single">ادامه مطلب...</a>
                                    </div>
                            ...
                            <div class="blog-item box-border">
                                ...
                                <div class="blog-content">
                                    <ul class="list-inline mt-4">
                                        <li class="list-inline-item">
                                            <i class="lni-calendar base-color"></i>
                                            <span class="text-muted">12 مرداد 1401 </span>
                                        </li>
                                        <li class="list-inline-item">
                                            <i class="lni-comment base-color"></i>
                            ...
                            <div class="blog-item box-border">
                                ...
                                <div class="blog-content">
                                    <ul class="list-inline mt-4">
                                        <li class="list-inline-item">
                                            <i class="lni-calendar base-color"></i>
                                            <span class="text-muted">16 شهریور 1401 </span>
                                        </li>
                                        <li class="list-inline-item">
                                            <i class="lni-comment base-color"></i>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="button-border">
                                <a href="blog-rtl.html" class="pill-button">مشاهده بیشتر</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="display-content">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center title">
                                <h2 class="text-dark"><span class="base-color">ارتباط</span> با من</h2>
                                <p class="text-muted mb-5 max-width-450">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 mt-5">
                            <div class="text-center">
                                ...
                                <div class="mt-3">
                                    ...
                                    <small class="text-muted">09171234567</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 mt-5">
                            <div class="text-center">
                                ...
                                <div class="mt-3">
                                    <h5 class="text-dark mb-0 contact_detail-title">آدرس دفتر</h5>
                                    <small class="text-muted">فارس ، شیراز ، قصرالدشت</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 mt-5">
                            <div class="text-center">
                                ...
                                <div class="mt-3">
                                    <h5 class="text-dark mb-0">ایمیل من</h5>
                        ...
                        <div class="col-lg-12 mt-5 contact-form">
                            <form id="contactForm">
                                <div class="row">
                                    ...
                                    <div class="col-12 form-item">
                                        <div class="input-group mb-3">
                                            <textarea name="comments" id="comments" rows="4" class="form-control" placeholder="متن پیام..."></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 mt-4 text-start position-relative">
                                        <div class="button-border">
                    ...
                    <div class="row copy-right">
                        <div class="col-12 text-center">
                            <p>حق نشر محفوظ است. طراحی قالب توسط <span class="base-color">مینا تارخ</span></p>
                        </div>
                    </div>
                </div>
            </div>
...
<!--  Plugin Js  -->
<script src="assets/js/plugins.html"></script>
<!--  Custom JS  -->
